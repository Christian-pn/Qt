...
class AddressBookEntry : public QObject
{
    ...
    Q_PROPERTY(QString birthday READ birthday WRITE setBirthday NOTIFY addressChanged)
    Q_PROPERTY(QString phoneNumbers READ phoneNumbers WRITE setPhoneNumbers NOTIFY phoneNumbersChanged)
public:
